  ...
  return (
    ...
    <div className="container mx-auto">
        <header className="py-8 text-center">
            ...
            <p className="text-lg text-gray-400">Trade, Exchange, and Connect with Others</p>
        </header>
        ...
        {user ? (
            ...
            <div>
                ...
                <h2 className="text-2xl font-semibold text-gray-400 mb-9">How It Works</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    <div className="text-center">
                        <Image src="/img/1.png" alt="Icon 1" width={100} height={100} style={{display: 'inline'}}/>
                        <h3 className="text-lg font-semibold text-gray-200 my-2">Browse Listings</h3>
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-200 my-2">Negotiate Trades</h3>
                        <p className="text-gray-400">Connect with other users and discuss trade options.</p>
                    </div>
                    <div className="text-center">
                        <Image src="/img/3.png" alt="Icon 1" width={100} height={100} style={{display: 'inline'}}/>
                        <h3 className="text-lg font-semibold text-gray-200 my-2">Complete the Trade</h3>
                        <p className="text-gray-400">Finalize your trade and exchange items or services.</p>
                    </div>
                </div>
                </section>
            </div>
